...
| [Benchmarks](benchmarks/README.md) | Records reviewed, reproducible performance baselines and their limitations. | [Mac CPU v0.3](benchmarks/mac-cpu-v0.3.md), [ROG CPU v0.3](benchmarks/rog-cpu-v0.3.md) |
